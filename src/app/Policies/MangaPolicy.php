...
class MangaPolicy
{
    ...
    {
        return $user->can('view_any_manga');
    }
    ...
    {
        return $user->can('delete_any_manga');
    }
     ...
     */
    public function replicate(User $user, Manga $manga): bool
    {
